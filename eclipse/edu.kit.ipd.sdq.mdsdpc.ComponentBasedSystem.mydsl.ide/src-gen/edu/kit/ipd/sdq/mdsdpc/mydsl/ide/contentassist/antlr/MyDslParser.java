		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getComponentBasedSystemAccess().getGroup_12(), "rule__ComponentBasedSystem__Group_12__0");
					put(grammarAccess.getComponentBasedSystemAccess().getGroup_12_3(), "rule__ComponentBasedSystem__Group_12_3__0");
					put(grammarAccess.getComponentBasedSystemAccess().getGroup_13(), "rule__ComponentBasedSystem__Group_13__0");
					put(grammarAccess.getComponentBasedSystemAccess().getGroup_13_3(), "rule__ComponentBasedSystem__Group_13_3__0");
					...
					put(grammarAccess.getComponentBasedSystemAccess().getRepositoryAssignment_9_1(), "rule__ComponentBasedSystem__RepositoryAssignment_9_1");
					put(grammarAccess.getComponentBasedSystemAccess().getAllocationAssignment_10_1(), "rule__ComponentBasedSystem__AllocationAssignment_10_1");
					put(grammarAccess.getComponentBasedSystemAccess().getAssemblycontextAssignment_11_2(), "rule__ComponentBasedSystem__AssemblycontextAssignment_11_2");
					put(grammarAccess.getComponentBasedSystemAccess().getAssemblycontextAssignment_11_3_1(), "rule__ComponentBasedSystem__AssemblycontextAssignment_11_3_1");
					put(grammarAccess.getComponentBasedSystemAccess().getTypeAssignment_12_2(), "rule__ComponentBasedSystem__TypeAssignment_12_2");
					put(grammarAccess.getComponentBasedSystemAccess().getTypeAssignment_12_3_1(), "rule__ComponentBasedSystem__TypeAssignment_12_3_1");
					put(grammarAccess.getComponentBasedSystemAccess().getAssemblyconnectorAssignment_13_2(), "rule__ComponentBasedSystem__AssemblyconnectorAssignment_13_2");
					put(grammarAccess.getComponentBasedSystemAccess().getAssemblyconnectorAssignment_13_3_1(), "rule__ComponentBasedSystem__AssemblyconnectorAssignment_13_3_1");

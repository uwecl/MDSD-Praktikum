 ...
 * </p>
 * <ul>
 *   <li>{@link componentBasedSystem.behaviourDescription.impl.BehaviourDescriptionImpl#getDescriptionelement <em>Descriptionelement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BehaviourDescriptionImpl extends MinimalEObjectImpl.Container implements BehaviourDescription {
	...
	protected EClass eStaticClass() {
		return BehaviourDescriptionPackage.Literals.BEHAVIOUR_DESCRIPTION;
	}
	...
	public EList<DescriptionElement> getDescriptionelement() {
		if (descriptionelement == null) {
			descriptionelement = new EObjectContainmentEList<DescriptionElement>(DescriptionElement.class, this, BehaviourDescriptionPackage.BEHAVIOUR_DESCRIPTION__DESCRIPTIONELEMENT);
		}

 ...
 */
package edu.kit.ipd.sdq.mdsdpc.system.serializer;
...
public class SystemSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *         providedAssemblyContext=[AssemblyContext|EString] 
	 *         requiredAssemblyContext=[AssemblyContext|EString]
	 *     )
	 */
	protected void sequence_AssemblyConnector(ISerializationContext context, AssemblyConnector semanticObject) {
		if (errorAcceptor != null) {
			...
			if (transientValues.isValueTransient(semanticObject, RolesPackage.Literals.ASSEMBLY_CONNECTOR__PROVIDED_ASSEMBLY_CONTEXT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, RolesPackage.Literals.ASSEMBLY_CONNECTOR__PROVIDED_ASSEMBLY_CONTEXT));
			if (transientValues.isValueTransient(semanticObject, RolesPackage.Literals.ASSEMBLY_CONNECTOR__REQUIRED_ASSEMBLY_CONTEXT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, RolesPackage.Literals.ASSEMBLY_CONNECTOR__REQUIRED_ASSEMBLY_CONTEXT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		...
		feeder.accept(grammarAccess.getAssemblyConnectorAccess().getProvidedAssemblyContextAssemblyContextEStringParserRuleCall_8_0_1(), semanticObject.getProvidedAssemblyContext());
		feeder.accept(grammarAccess.getAssemblyConnectorAccess().getRequiredAssemblyContextAssemblyContextEStringParserRuleCall_10_0_1(), semanticObject.getRequiredAssemblyContext());
		feeder.finish();
	}
	 ...
	 *         providedrole+=[ProvidedRole|EString] 
	 *         providedrole+=[ProvidedRole|EString]* 
	 *         (requiredrole+=[RequiredRole|EString] requiredrole+=[RequiredRole|EString]*)? 

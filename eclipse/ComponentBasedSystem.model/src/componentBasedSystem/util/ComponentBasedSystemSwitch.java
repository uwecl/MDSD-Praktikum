 ...
 * @generated
 */
public class ComponentBasedSystemSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ComponentBasedSystemSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ComponentBasedSystemPackage.COMPONENT_BASED_SYSTEM: {
				ComponentBasedSystem componentBasedSystem = (ComponentBasedSystem)theEObject;
				T result = caseComponentBasedSystem(componentBasedSystem);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Component Based System</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Component Based System</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseComponentBasedSystem(ComponentBasedSystem object) {
		return null;
	}

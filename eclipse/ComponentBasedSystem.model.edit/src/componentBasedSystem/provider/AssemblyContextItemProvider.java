...
/**
 * This is the item provider adapter for a {@link componentBasedSystem.AssemblyContext} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssemblyContextItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AssemblyContext_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AssemblyContext_name_feature", "_UI_AssemblyContext_type"),
				 ComponentBasedSystemPackage.Literals.ASSEMBLY_CONTEXT__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_AssemblyContext_component_feature", "_UI_AssemblyContext_type"),
				 ComponentBasedSystemPackage.Literals.ASSEMBLY_CONTEXT__COMPONENT,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AssemblyContext.class)) {
			case ComponentBasedSystemPackage.ASSEMBLY_CONTEXT__NAME:

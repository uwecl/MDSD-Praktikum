...
/**
 * This is the item provider adapter for a {@link componentBasedSystem.Component} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ComponentBasedSystemPackage.Literals.COMPONENT__NAME,
				 true,
				 false,
				 false,
		...
		newChildDescriptors.add
			(createChildParameter
				(ComponentBasedSystemPackage.Literals.COMPONENT__BEHAVIOURDESCRIPTION,
				 BehaviourDescriptionFactory.eINSTANCE.createBehaviourDescription()));

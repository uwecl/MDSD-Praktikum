...
/**
 * This is the item provider adapter for a {@link componentBasedSystem.Interface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ComponentBasedSystemPackage.Literals.INTERFACE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addInheritedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interface_inherited_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interface_inherited_feature", "_UI_Interface_type"),
				 ComponentBasedSystemPackage.Literals.INTERFACE__INHERITED,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ComponentBasedSystemPackage.Literals.INTERFACE__SIGNATURE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ComponentBasedSystemPackage.Literals.INTERFACE__SIGNATURE,
				 ComponentBasedSystemFactory.eINSTANCE.createSignature()));
	}

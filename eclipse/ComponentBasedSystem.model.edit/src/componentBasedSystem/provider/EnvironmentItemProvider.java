...
/**
 * This is the item provider adapter for a {@link componentBasedSystem.Environment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnvironmentItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Environment_name_feature", "_UI_Environment_type"),
				 ComponentBasedSystemPackage.Literals.ENVIRONMENT__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ComponentBasedSystemPackage.Literals.ENVIRONMENT__CONTAINER);
			childrenFeatures.add(ComponentBasedSystemPackage.Literals.ENVIRONMENT__LINK);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ComponentBasedSystemPackage.Literals.ENVIRONMENT__CONTAINER,
				 ComponentBasedSystemFactory.eINSTANCE.createContainer()));

		newChildDescriptors.add
			(createChildParameter
				(ComponentBasedSystemPackage.Literals.ENVIRONMENT__LINK,
				 ComponentBasedSystemFactory.eINSTANCE.createLink()));
	}

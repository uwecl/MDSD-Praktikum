...
/**
 * This is the item provider adapter for a {@link componentBasedSystem.Link} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ComponentBasedSystemPackage.Literals.LINK__NAME,
				 true,
				 false,
				 false,
	...
	protected void addContainerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Link_container_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Link_container_feature", "_UI_Link_type"),
				 ComponentBasedSystemPackage.Literals.LINK__CONTAINER,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Link.class)) {
			case ComponentBasedSystemPackage.LINK__NAME:

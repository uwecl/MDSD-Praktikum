...
import edu.kit.ipd.sdq.mdsdpc.mydsl.formatting.MyDslFormatter;
import edu.kit.ipd.sdq.mdsdpc.mydsl.generator.MyDslGenerator;
import edu.kit.ipd.sdq.mdsdpc.mydsl.parser.antlr.MyDslAntlrTokenFileProvider;
import edu.kit.ipd.sdq.mdsdpc.mydsl.parser.antlr.MyDslParser;
import edu.kit.ipd.sdq.mdsdpc.mydsl.parser.antlr.internal.InternalMyDslLexer;
import edu.kit.ipd.sdq.mdsdpc.mydsl.scoping.MyDslScopeProvider;
import edu.kit.ipd.sdq.mdsdpc.mydsl.serializer.MyDslSemanticSequencer;
import edu.kit.ipd.sdq.mdsdpc.mydsl.serializer.MyDslSyntacticSequencer;
import edu.kit.ipd.sdq.mdsdpc.mydsl.services.MyDslGrammarAccess;
import edu.kit.ipd.sdq.mdsdpc.mydsl.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "edu/kit/ipd/sdq/mdsdpc/mydsl/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("edu.kit.ipd.sdq.mdsdpc.mydsl.MyDsl");
	}

...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>roles</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class RolesExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.roles"));
				Role root = RolesFactory.eINSTANCE.createRole();
